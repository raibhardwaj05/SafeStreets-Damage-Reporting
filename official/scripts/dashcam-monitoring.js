    ...
    reader.onload = function(e) {
        ...
        if (afterImg) {
            ...
            if (type === 'first') {
                ...
                currentReport.fileFirst = file;
            } else {
                currentReport.tempAfterPhotoLast = imageData;
                currentReport.fileLast = file;
            }
...
async function submitFinalReport() {
    ...
    try {
        ...
        if (currentReport && currentReport.fileFirst) {
            formData.append('after_image', currentReport.fileFirst);
        }
        if (currentReport && currentReport.fileLast) {
            formData.append('after_image_last', currentReport.fileLast);
        }
